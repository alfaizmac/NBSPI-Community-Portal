...
<html lang="en">
    ...
    <head>
        <meta charset="UTF-8">
        <title>Register | NBSPI Community Portal</title>
    ...
    <body>
        ...
        <main class="edit-profile">
            <section class="profile-form">
                ...
                <!-- Display error message if the username is found -->
                <?php if (isset($_GET['error']) && $_GET['error'] == 'username_taken') { ?>
                    <p class="error-message">Username already taken. Please choose another one.</p>
                <?php } ?>
